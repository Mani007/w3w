...
const Countdown = () => {
  ...
  const startCountDown = useCallback(() => {
    ...
    const countDownDate = new Date(
      ...
      customDate.getMonth(),
      customDate.getDate() + 8,
      customDate.getHours() + 11,
  ...
  return (
    <div className="h-1/2  w-screen flex items-center justify-center bg-gradient-to-bl from-blue-400 via-blue-200 to-blue-400">
