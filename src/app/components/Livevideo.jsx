...
function Livevideo() {
  return (
    ...
    <p className='py-8 text-white text-center text-4xl font-bold'>THANK YOU ALL FOR JOINING US!!!</p>
    <p className='py-8 text-white text-center text-4xl font-bold'>Event AFTER-MOVIE coming soon...</p>
